...
describe("DirectDonationFactory", function () {
  ...
  async function deploy() {
    ...
    const DirectDonationFactory = await ethers.getContractFactory("DirectDonationFactory");
    const directDonationFactory = await DirectDonationFactory.deploy();
    await directDonationFactory.deployed()

    return { directDonationFactory, owner, otherAccount };
  }
