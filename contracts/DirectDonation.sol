...
contract DirectDonation is PercentRecord, Ownable, IDirectDonation {
    ...
    function donate() external payable {
        ...
        while (iter < PercentRecord.count){
            ...
            if (iterAllocation.objAddress != address(0)){
                ...
                (bool sent, bytes memory data) = iterAllocation.objAddress.call{value: transferable}("");
    ...
    function withdrawContractBalance() external onlyOwner{
        ...
        (bool sent, bytes memory data) = Ownable.owner().call{value: contractBalance}("");
        require(sent,"Failed to send Ether");
    }
